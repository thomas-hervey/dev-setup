...
sudo scutil --set ComputerName "Thomas' MacBook Pro"
sudo scutil --set HostName "Thomas' Computer"
sudo scutil --set LocalHostName "Thomas-MacBook-Pro.local"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Thomas-MacBook-Pro.local"
